...
SWEP.WorldModel = "models/w_sg.mdl"
...
if CLIENT then
	SWEP.WepSelectIcon = surface.GetTextureID("ent/w_weapons/shota0")
	killicon.Add("d64_sg", "ent/w_weapons/shota0", Color(255, 255, 255, 255))
end
